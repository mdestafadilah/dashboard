...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'background-color: #FFFFFF; font-family: "Trebuchet MS"; font-size: x-small;';
...
this.stylesheet = "http://localhost/icis/css/tmk_icis.css"; // full URL to stylesheet
