...
function bukaWindowBaru(winURL){
  var Wheight= screen.height*0.51;
  var Wwidth= screen.width*0.67;
  winName = "popWin"
  popWin = window.open(winURL, "posisiinput", "toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=0, width=" + Wwidth + ",height=" + Wheight)
  }
...
function tambahIsian(idTerakhir,divTerakhir){
    ...
    divBaru += '<TABLE CELLSPACING=1 CELLPADDING=2 BGCOLOR=#FFFFFF width=51%>\n';
    divBaru += '<tmk></tmk><TR bgcolor='+bgcolor+'>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;'+no+'&nbsp; </TD>\n';
    divBaru += '        <TD VALIGN=TOP align=center><INPUT id=distno'+idTerakhir+' TYPE=TEXT NAME=name[] STYLE="width:450px;text-align:left;"></TD>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsian('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsian2(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsian2('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
...
function tambahIsianMasterKRA(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianMasterKRA('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianMasterOBJ(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianMasterOBJ('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianMasterKPI(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianMasterKPI('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianSubjekKuis(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianSubjekKuis('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianPertanyaanKuis(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianPertanyaanKuis('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianJabatan(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianJabatan('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianFormCoach(idTerakhir,divTerakhir){
	...
	divBaru += '    <td>&nbsp;<a title=\'ADD NEW ROW\' href="javascript: tambahIsianFormCoach('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a></td>\n';
    divBaru += '  </tr>\n';
    divBaru += '</table>\n';
...
function tambahIsianFormCoach2(idTerakhir,divTerakhir){
    ...
    divBaru += '      <td><a title=\'ADD NEW ROW\' href="javascript: tambahIsianFormCoach2('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a></li></td>\n';
    divBaru += '  </tr>\n';
    divBaru += '  </table>\n';
...
function tambahKPI(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=17% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahKPI('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahOBJ(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=17% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahOBJ('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahKRA(idTerakhir,divTerakhir){
    ...
    divBaru += '        <TD VALIGN=TOP width=17% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahKRA('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
	...
	function tambahIsianCPS(idTerakhir,divTerakhir){
    ...
    divBaru += '<TABLE CELLSPACING=1 CELLPADDING=2 BGCOLOR=#FFFFFF width=71%>\n';
    divBaru += '<tmk></tmk><TR bgcolor='+bgcolor+'>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;'+no+'&nbsp; <INPUT TYPE=hidden ID=cps_id'+idTerakhir+' NAME=id[] STYLE="width:100px;text-align:center;" value="0"></TD>\n';
    divBaru += '        <TD VALIGN=TOP width=10% align=center><INPUT TYPE=TEXT ID=cps_desc'+idTerakhir+' NAME=category[] STYLE="width:100px;text-align:left;"></TD>\n';    
	divBaru += '        <TD VALIGN=TOP width=23% align=center><INPUT TYPE=text ID=cps_name'+idTerakhir+' NAME=description[] STYLE="width:350px;text-align:left;"></TD>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianCPS('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
...
function tambahIsianTingkat(idTerakhir,divTerakhir){
    ...
    divBaru += '<tmk></tmk><TR bgcolor='+bgcolor+'>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;'+no+'&nbsp; </TD>\n';
	divBaru += '        <TD VALIGN=TOP width=10% align=center><INPUT TYPE=HIDDEN ID=tingkat_id'+idTerakhir+' NAME=id[] STYLE="width:100px;text-align:center;">\n';
	divBaru += '		<INPUT TYPE=TEXT ID=tingkat_name'+idTerakhir+' NAME=tingkat[] STYLE="width:100px;text-align:left;"></TD>\n';
    divBaru += '        <TD VALIGN=TOP width=50% align=center><INPUT TYPE=TEXT ID=tingkat_keterangan'+idTerakhir+' NAME=keterangan[] STYLE="width:350px;text-align:left;"></TD>\n';
    divBaru += '        <TD VALIGN=TOP width=5% align=center> &nbsp;<a title="ADD NEW ROW" href="javascript: tambahIsianTingkat('+idTambahan+',\'div'+idTambahan+'\')"><img src=images/page.gif height=14 width=14 border=0></a>&nbsp;</TD>\n';
    divBaru += '    </TR>\n';
    divBaru += '</TABLE>\n';
	  if (idTerakhir >= jumlahDiv){
        document.getElementById(divTerakhir).innerHTML= divBaru;
